import { ItemCarrito, useCarritoCompras } from "../../context/carrito";
...
export const CantidadPedido = ({ cantidad,id}: CantidadPedidoProps) => {
    const {aumentarCantidadProducto,disminuirCantidadProducto} = useCarritoCompras()
    return (
        <>
            <div className="precio-producto" style={{ display: "inline-flex", alignItems: "center", marginLeft:"1rem"}}>
                <span style={{ display: "inline-flex", alignItems: "center" }}>
                    ...
                    <p style={{ fontSize: "18px", marginBottom:"0px" }}>{cantidad}</p>
                </span>
                <span style={{ display: "inline-flex", alignItems: "center" }}>
